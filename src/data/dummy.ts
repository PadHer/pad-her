...
export const DONOR_HISTORY = [
  {
    ...
    date: "2026-04-12",
    amount: 5000,
    campaign: "Sanitary Pads Drive Q2 2026",
    status: "Completed",
  },
  {
    id: "hist_2",
    date: "2026-03-01",
    amount: 10000,
    campaign: "Rural Schools Menstrual Ed",
    status: "Completed",
  },
  {
    id: "hist_3",
    date: "2026-01-15",
    amount: 2500,
    campaign: "Lagos Community Outreach",
    status: "Completed",
  },
  {
    id: "hist_4",
  ...
  },
  {
    ...
    date: "2025-07-18",
    amount: 7500,
    campaign: "Summer Workshop Support",
    status: "Completed",
  },
  {
    id: "hist_7",
    date: "2025-05-10",
    amount: 5000,
    campaign: "Sanitary Pads Drive Q2 2025",
    status: "Completed",
  },
  {
    id: "hist_8",
    date: "2025-02-28",
    amount: 5000,
    campaign: "First Quarter Outreach",
    status: "Completed",
  },
];
...
export const ALL_DONATIONS = [
  ...ADMIN_RECENT_DONATIONS.map((d) => ({
    ...d,
    status: d.amount > 5000 ? "confirmed" : "pending",
  })),
  {
    id: "ad_16",
    name: "Michael O.",
...
export const EVENTS = [
  {
    id: "ev_1",
    title: "Q2 Pads Distribution",
    type: "campaign",
    date: "2026-06-15",
    location: "Lagos",
    description: "Main distribution event for Q2.",
    capacity: 500,
    attendees: 120,
    status: "upcoming",
  },
  {
    ...
    date: "2026-05-20",
    location: "Ikeja",
    description: "Educational workshop for teens.",
    capacity: 100,
    attendees: 85,
    status: "upcoming",
  },
  {
    ...
    date: "2026-05-10",
    location: "Ogun",
    description: "Visiting schools in Ogun state.",
    capacity: 300,
    attendees: 300,
    status: "completed",
  },
  {
    ...
    date: "2026-07-01",
    location: "Abuja",
    description: "Health drive in Abuja.",
    capacity: 1000,
    attendees: 0,
    status: "upcoming",
  },
  {
    ...
    date: "2026-05-25",
    location: "Online",
    description: "Training for new volunteers.",
    capacity: 50,
    attendees: 45,
    status: "upcoming",
  },
  {
    id: "ev_6",
    title: "Hygiene Essentials Giveaway",
    type: "outreach",
    date: "2026-04-15",
    location: "Ibadan",
    description: "Giving away hygiene kits.",
    capacity: 200,
    attendees: 200,
    status: "completed",
  },
  {
    ...
    date: "2026-12-10",
    location: "Lagos",
    description: "End of year fundraising gala.",
    capacity: 250,
    attendees: 50,
    status: "upcoming",
  },
  {
    id: "ev_8",
    title: "School Health Talk",
    type: "workshop",
    date: "2026-06-05",
    location: "Port Harcourt",
    description: "Health talk in secondary schools.",
    capacity: 150,
    attendees: 10,
    status: "upcoming",
  },
...
export const BLOG_POSTS = [
  {
    id: "bp_1",
    title: "Why Menstrual Education Matters",
    author: "Ngozi A.",
    date: "2026-05-10",
    status: "published",
    tags: ["Education", "Health"],
    excerpt: "A look into the importance of educating teens.",
    content: "Full content...",
  },
  {
    id: "bp_2",
    title: "Highlights from our Q1 Drive",
    author: "PadHer Team",
    date: "2026-04-05",
    status: "published",
    tags: ["Campaigns", "Impact"],
    excerpt: "See what we achieved in Q1.",
    content: "Full content...",
  },
  {
    id: "bp_3",
    ...
    date: "2026-05-15",
    status: "draft",
    tags: ["Stigma", "Community"],
    excerpt: "How we can break the silence.",
    content: "Full content...",
  },
  {
    id: "bp_4",
    title: "Volunteer Spotlight: Amina",
    author: "PadHer Team",
    date: "2026-03-20",
    status: "published",
    tags: ["Volunteers"],
    excerpt: "Meet Amina, our star volunteer.",
    content: "Full content...",
  },
  {
    id: "bp_5",
    title: "Upcoming Events in Lagos",
    author: "Ngozi A.",
    date: "2026-05-20",
    status: "draft",
    tags: ["Events", "Lagos"],
    excerpt: "What's happening next month.",
    content: "Full content...",
  },
  {
    id: "bp_6",
    title: "How to Support PadHer",
    author: "PadHer Team",
    date: "2026-02-14",
    status: "published",
    tags: ["Donations", "Support"],
    excerpt: "Different ways you can help our cause.",
    content: "Full content...",
  },
];
...
export const VOLUNTEER_ROLES = [
  {
    ...
    description: "Help organize our outreach events.",
    requirements: "Organization skills, local to Lagos.",
    openSlots: 2,
    applicationsCount: 5,
  },
  {
    ...
    description: "Write blog posts and social content.",
  ...
  },
  {
    ...
    description: "Assist with transporting pads.",
  ...
  },
  {
    ...
    description: "Represent PadHer in your community.",
    requirements: "Passionate about our cause.",
    openSlots: 5,
  ...
  },
  {
    ...
    description: "Create visuals for our campaigns.",
    requirements: "Experience with design tools.",
    openSlots: 1,
    applicationsCount: 4,
  },
];
...
export const EVENT_ATTENDEES = [
  {
    ...
    eventId: "ev_2",
    eventName: "Menstrual Health Workshop",
  ...
  },
  {
    ...
    eventId: "ev_1",
    eventName: "Q2 Pads Distribution",
