  ...
  return (
    <div className="w-full bg-[#FFF] flex flex-col items-center justify-center overflow-hidden relative">
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center">
        <div className="w-full h-[80%] mt-[10dvh] flex justify-between px-24 py-16">
          <h1
            className="font-playfair font-extrabold text-[150px] md:text-[150px] text-[#111111] inset-0 leading-[150px]"
            style={{
              fontFamily: "Yeseva",
            }}
          >
          ...
          <div className="w-1/2 rounded-[8px_60px_8px_60px] overflow-hidden relative">
            <Image
      ...
      <div className="w-full h-screen px-24 py-16 flex flex-col justify-between">
        <div className="w-full h-[45%] flex justify-between items-start">
          <div className="w-1/2 h-full rounded-[8px_60px_8px_60px] overflow-hidden relative">
            <Image
              src={"/images/join.jpg"}
              alt="About Image"
              fill
          ...
          <div className="w-[49%] flex flex-col justify-center">
            ...
            />
            <p
              className="text-[#393939] text-[16px] md:text-[24px] text-start w-full md:w-full leading-[36px]"
              style={{
                fontFamily: "OpenSans",
              }}
            >
        ...
        <div className="w-full h-[45%] flex justify-between items-start">
          <div className="w-[49%] flex flex-col justify-center">
            ...
            <Link
              className="button font-open mt-4 w-fit"
              href={""}
            >
              Support Our Mission
            </Link>
      ...
      <div className="w-full py-18 px-24 flex flex-col items-center gap-4 bg-[#FEF5F9F5]">
        <h2 className="text-[56px] font-extrabold font-playfair text-[#111111]">
          Our <b className="text-[#111111AD]">Approach</b>
        </h2>
        <p className="font-open font-normal text-[#393939] w-1/2 text-center">
        ...
        <div className="w-full flex justify-between mt-10">
          {aboutData.map((item, index) => (
            <div
              key={index}
              className="w-[24%] flex flex-col items-center gap-8 border-1 border-[#E7E7E7] py-10 px-8 shadow-[0px_4px_40px_0px_#0000000F] rounded-[16px] bg-[#FFFFFF]"
            >
      ...
      <div className="w-full flex items-start justify-between px-24 py-12">
        <div className="w-[57%] flex flex-col">
          ...
          />
          <p className="mt-6 text-[#393939CC] font-open font-normal">
